...
export function Dial({ now, lat, lon, onClose }: Props) {
  ...
  // 分環轉三分之二圈、日照弧只有四分之一多，看起來就是各轉各的。dur 也各差一點，
  // 六環不會同一瞬間一起剎車。
  //
    ...
    >
      <div class="dial-wrap">
        <svg viewBox="0 0 620 620" aria-hidden="true">
          ...
          <g style={spin(minAngle, 0.67, 4.9)}>
          ...
          {/* 二環：二十四小時，一天一圈，整點才跳 */}
          <g style={spin(hourAngle, 0.52, 5.1)}>
          ...
          <g style={spin(outerAngle, 0.37, 4.6)}>
          ...
          {/* 五環：日照弧 */}
          <g style={spin(sunAngle, 0.28, 4.4)}>
          ...
          <g class="sec" style={spin(secAngleRef.current, -1.04, 4.7)}>
